...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-configweave-detail.ps1

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-configweave-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-configweave-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-configweave-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
