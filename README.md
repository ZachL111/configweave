...
configweave is a Haskell project for developer tools. It focuses on this technical goal: Validate typed configuration overlays and provenance chains.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 174, risk penalty 5, latency penalty 2, and weight bonus 3. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
