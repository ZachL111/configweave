"""Regression checks for the configweave casebook."""
...
from casebook.harness import assert_expected, configweave_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(configweave_summary(), assert_expected())
