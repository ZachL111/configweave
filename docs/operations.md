...
`configweave` is centered on developer tools work in Haskell. The technical target is: Validate typed configuration overlays and provenance chains.
...
The score is deterministic. The current threshold is 174. Risk has a penalty of 5, latency has a penalty of 2, and weight contributes a bonus of 3.
